...
public class FourBladeFanVisual extends KineticBlockEntityVisual<FourBladeFanBlockEntity>implements SimpleDynamicVisual {
    ...
    public FourBladeFanVisual(VisualizationContext context, FourBladeFanBlockEntity blockEntity, float partialTick) {
        ...
        shaft.setup(FourBladeFanVisual.this.blockEntity)
                .setPosition(getVisualPosition())
                .rotateToFace(rotationAxis())
                .setChanged();

        wheel = instancerProvider()
                .instancer(InstanceTypes.TRANSFORMED, Models.partial(ReplacedDDBlockPartialModel.FOUR_BLADE_FAN))
                .createInstance();
