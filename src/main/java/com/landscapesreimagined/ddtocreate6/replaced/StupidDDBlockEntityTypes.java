...
public class StupidDDBlockEntityTypes {
    public static final BlockEntityEntry<FurnaceEngineBlockEntity> FURNACE_ENGINE = DDCreate.REGISTRATE
            .blockEntity("furnace_engine", FurnaceEngineBlockEntity::new)
            .validBlocks(DDBlocks.FURNACE_ENGINE)
            .renderer(() -> EngineRenderer::new)
            .register();
    public static final BlockEntityEntry<FlywheelBlockEntity> FLYWHEEL = DDCreate.REGISTRATE
            .blockEntity("flywheel", FlywheelBlockEntity::new)
            .validBlocks(DDBlocks.FLYWHEEL)
            .renderer(() -> FlywheelRenderer::new)
            .register();
    public static final BlockEntityEntry<BronzeSawBlockEntity> BRONZE_SAW = DDCreate.REGISTRATE
...
//            .instance(() -> BronzeSawInstance::new)
            ...
            .register();
    public static final BlockEntityEntry<BronzeDrillBlockEntity> BRONZE_DRILL = (DDCreate.REGISTRATE
...
//            .instance(() -> BronzeDrillInstance::new, false)
            ...
            .register();
    public static final BlockEntityEntry<KineticBlockEntity> ENCASED_SHAFT = DDCreate.REGISTRATE
            .blockEntity("encased_shaft", KineticBlockEntity::new)
//            .instance(() -> ShaftInstance::new, false)
            .validBlocks(DDBlocks.secondary_encased_chain_drive)
            .renderer((() -> (ShaftRenderer::new)))
            .register();
    public static final BlockEntityEntry<YIPPEESlidingDoorBlockEntity> SLIDING_DOOR = DDCreate.REGISTRATE
            .blockEntity("sliding_door", YIPPEESlidingDoorBlockEntity::new)
            .renderer(() -> YIPPEESlidingDoorRenderer::new)
            .validBlocks(new NonNullSupplier[]{DDBlocks.rose_door, DDBlocks.smoked_door, DDBlocks.spirit_door})
            .register();
    public static final BlockEntityEntry<PonderBoxBlockEntity> ponder_in_a_box = DDCreate.REGISTRATE
            .blockEntity("ponder_in_a_box", PonderBoxBlockEntity::new)
            .renderer(() -> PonderBoxRenderer::new)
            .validBlocks(DDBlocks.ponder_in_a_box)
            .register();
    public static final BlockEntityEntry<IndustrialFanBlockEntity> BRONZE_ENCASED_FAN = DDCreate.REGISTRATE
...
//            .instance(() -> IndustrialFanInstance::new, false)
            ...
            .register();
    public static final BlockEntityEntry<RadiantDrillBlockEntity> RADIANT_DRILL = DDCreate.REGISTRATE
...
//            .instance(() -> RadiantDrillInstance::new, false)
            ...
            .register();
    public static final BlockEntityEntry<ShadowDrillBlockEntity> SHADOW_DRILL = DDCreate.REGISTRATE
            .blockEntity("shadow_drill", ShadowDrillBlockEntity::new)
//            .instance(() -> ShadowDrillInstance::new, false)
            .validBlocks(DDBlocks.SHADOW_DRILL)
            .renderer(() -> ShadowDrillRenderer::new)
            .register();
    public static final BlockEntityEntry<ReversedGearboxBlockEntity> REVERSED_GEARSHIFT = DDCreate.REGISTRATE
            .blockEntity("gearshift", ReversedGearboxBlockEntity::new)
//            .instance(() -> SplitShaftInstance::new, false)
            .validBlocks(DDBlocks.REVERSED_GEARSHIFT)
            .renderer(() -> SplitShaftRenderer::new)
            .register();
    public static final BlockEntityEntry<HydraulicPressBlockEntity> hydraulic_press = DDCreate.REGISTRATE
...
//            .instance(() -> HYPressInstance::new)
            ...
            .register();
    public static final BlockEntityEntry<TwoBladeFanBlockEntity> two_blade_fan = DDCreate.REGISTRATE
...
//            .instance(() -> TwoBladeFanBlockInstance::new, false)
            ...
            .register();
    public static final BlockEntityEntry<FourBladeFanBlockEntity> four_blade_fan = DDCreate.REGISTRATE
...
//            .instance(() -> FourBladeFanBlockInstance::new, false)
            ...
            .register();
    public static final BlockEntityEntry<EightBladeFanBlockEntity> eight_blade_fan = DDCreate.REGISTRATE
...
//            .instance(() -> EightBladeFanBlockInstance::new, false)
            ...
            .register();
    public static final BlockEntityEntry<ChainGearshiftBlock2Entity> secondary_adjustable_chain_gearshift = DDCreate.REGISTRATE
...
//            .instance(() -> ShaftInstance::new, false)
            ...
            .renderer(() -> ShaftRenderer::new)
            .register();
    public static final BlockEntityEntry<KineticMotorBlockEntity> MOTOR = DDCreate.REGISTRATE
            .blockEntity("motor", KineticMotorBlockEntity::new)
//            .instance(() -> HalfShaftInstance::new, false)
            .validBlocks(DDBlocks.KINETIC_MOTOR)
            .renderer(() -> KineticMotorRenderer::new)
            .register();
    public static final BlockEntityEntry<AcceleratorMotorBlockEntity> AC_MOTOR = DDCreate.REGISTRATE
...
//            .instance(() -> HalfShaftInstance::new, false)
            ...
            .register();
    public static final BlockEntityEntry<PotatoTurretBlockEntity> POTATO_TURRET = DDCreate.REGISTRATE
...
//            .instance(() -> PotatoTurretInstance::new, false)
            ...
            .register();
    public static final BlockEntityEntry<CogCrankBlockEntity> cogCrank = DDCreate.REGISTRATE
