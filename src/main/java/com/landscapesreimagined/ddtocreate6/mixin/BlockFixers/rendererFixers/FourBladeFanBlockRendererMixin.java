...
@Mixin(FourBladeFanBlockRenderer.class)
public class FourBladeFanBlockRendererMixin {

    @WrapOperation(
            method = "renderSafe(Luwu/lopyluna/create_dd/block/BlockProperties/fan/FourBladeFanBlockEntity;FLcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;II)V",
