...
@Mixin(TwoBladeFanBlockRenderer.class)
public class TwoBladeFanBlockRendererMixin {

    @WrapOperation(
            method = "renderSafe(Luwu/lopyluna/create_dd/block/BlockProperties/fan/TwoBladeFanBlockEntity;FLcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;II)V",
