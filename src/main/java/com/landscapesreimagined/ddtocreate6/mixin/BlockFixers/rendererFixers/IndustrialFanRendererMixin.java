...
@Mixin(IndustrialFanRenderer.class)
public class IndustrialFanRendererMixin {


    @OnlyIn(Dist.CLIENT)
    @WrapOperation(
            method = "renderSafe(Luwu/lopyluna/create_dd/block/BlockProperties/industrial_fan/IndustrialFanBlockEntity;FLcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;II)V",
