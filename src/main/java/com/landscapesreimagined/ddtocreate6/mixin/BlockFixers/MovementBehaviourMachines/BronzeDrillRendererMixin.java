...
@Mixin(BronzeDrillRenderer.class)
public class BronzeDrillRendererMixin {
    ...
    public static void renderInContraption(MovementContext context, VirtualRenderWorld renderWorld,
        ...
        SuperByteBuffer superBuffer = CachedBuffers.partial(ReplacedDDBlockPartialModel.BRONZE_DRILL_HEAD, state);
